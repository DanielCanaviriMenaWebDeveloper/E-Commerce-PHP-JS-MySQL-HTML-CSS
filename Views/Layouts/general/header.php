    ...
    <body class="hold-transition sidebar-mini">
        ...
        <div class="wrapper">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a href="#" class="dropdown-item">
                            <!-- Message Start -->
                            <div class="media">
                            <img src="Util/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
                            <div class="media-body">
                                <h3 class="dropdown-item-title">
                                John Pierce
                    ...
                    <li class="nav-item" id="nav_login"><!-- id para ocultar elemento desde js -->
                    ...
                    <li class="nav-item dropdown" id="nav_usuario">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            <img id="avatar_nav" src="" width="30" height="30" alt="" class="img-fluid img-circle">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <img src="../Util/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
